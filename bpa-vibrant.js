...
s.textContent='.section-title{font-size:15px;font-weight:700;color:#0f172a;padding:12px 0;margin-bottom:16px;border-bottom:3px solid #1e40af;display:flex;align-items:center;gap:8px}.section-title .dot{width:8px;height:8px;border-radius:50%}.section-title.green{border-bottom-color:#059669}.section-title.red{border-bottom-color:#dc2626}.section-title.blue{border-bottom-color:#2563eb}.section-title.purple{border-bottom-color:#7c3aed}.section-title.orange{border-bottom-color:#ea580c}.section-title.teal{border-bottom-color:#0d9488}.kpi-card .kpi-icon{position:absolute;top:14px;right:14px;width:32px;height:32px;border-radius:10px;display:flex;align-items:center;justify-content:center;font-size:15px;opacity:.85}.rank-gold td{background:linear-gradient(90deg,rgba(255,215,0,.15) 0%,transparent 60%)!important}.rank-gold td:first-child{border-left:4px solid #fbbf24!important;font-weight:800!important}.rank-silver td{background:linear-gradient(90deg,rgba(192,192,192,.15) 0%,transparent 60%)!important}.rank-silver td:first-child{border-left:4px solid #9ca3af!important;font-weight:800!important}.rank-bronze td{background:linear-gradient(90deg,rgba(205,127,50,.12) 0%,transparent 60%)!important}.rank-bronze td:first-child{border-left:4px solid #d97706!important;font-weight:800!important}.inline-chart-row{display:grid;grid-template-columns:1fr 1fr;gap:16px;margin-bottom:16px}.inline-chart-card{background:#fff;border:1px solid #e2e8f0;border-radius:12px;padding:16px 20px;box-shadow:0 1px 2px rgba(0,0,0,.06);position:relative;overflow:hidden}.inline-chart-card::before{content:"";position:absolute;top:0;left:0;right:0;height:4px;border-radius:12px 12px 0 0}.inline-chart-card.accent-blue::before{background:linear-gradient(90deg,#2563eb,#60a5fa)}.inline-chart-card.accent-green::before{background:linear-gradient(90deg,#059669,#34d399)}.inline-chart-card.accent-purple::before{background:linear-gradient(90deg,#7c3aed,#a78bfa)}.inline-chart-card.accent-orange::before{background:linear-gradient(90deg,#ea580c,#fb923c)}.inline-chart-card.accent-red::before{background:linear-gradient(90deg,#dc2626,#f87171)}.inline-chart-card.accent-teal::before{background:linear-gradient(90deg,#0d9488,#5eead4)}.inline-chart-card h4{font-size:12px;font-weight:700;text-transform:uppercase;letter-spacing:.5px;margin-bottom:12px;display:flex;align-items:center;gap:6px}.inline-chart-card h4 .chart-dot{width:8px;height:8px;border-radius:50%}.forecast-progress-wrap{margin-bottom:10px}.forecast-progress-label{display:flex;justify-content:space-between;font-size:11px;font-weight:600;margin-bottom:4px}.forecast-progress-label .target-value{font-family:"IBM Plex Mono",monospace;font-weight:700}.forecast-progress-bar{height:8px;background:rgba(0,0,0,.06);border-radius:4px;overflow:hidden}.forecast-progress-fill{height:100%;border-radius:4px;transition:width .8s ease}.forecast-progress-fill.green{background:linear-gradient(90deg,#059669,#34d399)}.forecast-progress-fill.blue{background:linear-gradient(90deg,#2563eb,#60a5fa)}.forecast-progress-fill.orange{background:linear-gradient(90deg,#ea580c,#fb923c)}.forecast-progress-fill.red{background:linear-gradient(90deg,#dc2626,#f87171)}.forecast-progress-fill.purple{background:linear-gradient(90deg,#7c3aed,#a78bfa)}.bpa-panel .bpa-header{background:linear-gradient(135deg,rgba(30,64,175,.08),rgba(30,64,175,.02))!important;margin:-16px -20px 14px!important;padding:14px 20px!important;border-radius:12px 12px 0 0!important;border-bottom:2px solid rgba(30,64,175,.12)!important}.view-hero{position:relative!important;padding-left:16px!important}.view-hero::before{content:"";position:absolute;left:0;top:0;bottom:16px;width:4px;border-radius:2px;background:linear-gradient(180deg,#1e40af,#3b82f6)}.sparkline-card{background:#fff;border:1px solid #e2e8f0;border-radius:12px;padding:14px 18px;display:flex;align-items:center;gap:14px;position:relative;overflow:hidden}.sparkline-card::before{content:"";position:absolute;top:0;left:0;right:0;height:4px;background:linear-gradient(90deg,#0d9488,#5eead4)}.sparkline-card .spark-label{font-size:10px;text-transform:uppercase;letter-spacing:1.2px;color:#64748b;font-weight:700;margin-bottom:4px}.sparkline-card .spark-value{font-size:22px;font-weight:800;font-family:"IBM Plex Mono",monospace;color:#0d9488}.sparkline-card .spark-chart{flex:1;height:50px}.ops-grid-wrap>h3{position:relative!important;padding-left:12px!important}.ops-grid-wrap>h3::before{content:"";position:absolute;left:0;top:50%;transform:translateY(-50%);width:4px;height:20px;border-radius:2px;background:#1e40af}';
